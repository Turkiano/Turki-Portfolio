...
export default function ResearchOne() {
  ...
  const imageUrl = "https://i.postimg.cc/jjgPfcnk/Real-State-In-KSA.png";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-3">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <p className="text-sm text-gray-700 mb-4 mt-5">
              {t("ResearchOne.paragraph")}
            </p>
            <div className="flex justify-center">
              <a
                href="/Research/RealState in KSA/Modern Apartments for Sale _ by Turki.pdf"
                download
              >
